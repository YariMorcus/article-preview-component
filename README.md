...
- Solution URL: [Open GitHub repository](https://github.com/YariMorcus/article-preview-component)
- Live Site URL: [open GitHub Pages of repository](https://yarimorcus.github.io/article-preview-component)
...
6. How to use DOM API functions to manipulate the DOM (creating, adjusting, adding classes etc.)
